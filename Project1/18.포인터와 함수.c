...
//2. 배열 포인터
//퍼인터는 주소이기에 1차원에 대한 전달 값을 처리할 수 있습니다.
...
int main()
{
	...
	printArray(iarry, 5);//배열에 대한 전달 시, 배열의 이름만 전달합니다.(배열의 이름 == 배열의 주소)
